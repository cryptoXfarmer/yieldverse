...
import { Globe, Rocket, ArrowRight, Zap, DollarSign, Shield, Target, Heart, ChevronDown, ExternalLink } from 'lucide-react'
    ...
    <div className="fixed inset-0 z-[1] pointer-events-none overflow-hidden">
      {particles.map(p => (
        <div
          ...
          style={{
            left: `${p.left}%`,
            width: p.type === 2 ? `${p.size * 0.3}px` : `${p.size}px`,
            height: `${p.size}px`,
            background: p.color,
            borderRadius: p.type === 1 ? '50%' : '2px',
            opacity: 0.9,
            animation: `confetti-fall ${p.dur}s linear infinite`,
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 pt-20">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative">
          ...
          {/* Badge */}
          <div
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-cyan-400/30 mb-8"
            style={{
              background: 'linear-gradient(135deg, rgba(0,240,255,0.08), rgba(255,0,234,0.08))',
          ...
          {/* Main title */}
          <h1
            className="text-6xl md:text-8xl lg:text-9xl font-black mb-2 leading-[0.95]"
            style={{ animation: 'fadeSlideIn 1s ease-out 0.7s both' }}
          >
            <span className="block bg-gradient-to-r from-cyan-400 to-pink-400 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(0,240,255,0.3)]">
              CASH OUT
            </span>
            <span
              className="block text-[1.15em] mt-1"
              style={{
                color: '#ffe600',
                textShadow: '0 0 40px rgba(255,230,0,0.4), 0 0 80px rgba(255,230,0,0.15)',
              }}
            >
              $0.01
            </span>
          ...
          <p
            ...
            style={{ animation: 'fadeSlideIn 0.8s ease-out 0.9s both' }}
          >
          ...
          <div
            ...
            style={{ animation: 'fadeSlideIn 1.2s ease-out 1.1s both' }}
          >
            <div className="relative overflow-hidden p-8 md:p-10 text-center border-2 border-transparent"
              style={{
                background: 'linear-gradient(135deg, rgba(0,240,255,0.06), rgba(255,0,234,0.06), rgba(255,230,0,0.04))',
                borderImage: 'linear-gradient(135deg, #00f0ff, #ff00ea, #ffe600) 1',
              }}
            >
              {/* Animated glow behind */}
              <div className="absolute inset-[-2px] -z-10 blur-[15px] opacity-30"
                style={{
                  background: 'linear-gradient(135deg, #00f0ff, #ff00ea, #ffe600, #00f0ff)',
                  backgroundSize: '300% 300%',
                  animation: 'gradientShift 4s linear infinite',
                }}
              />

              <p className="font-mono text-lg text-gray-500 line-through decoration-red-500 decoration-[3px] mb-1">
                Old minimum: 100 YES ($0.10)
              </p>
              ...
              <span
                className="inline-block mt-4 px-4 py-1.5 bg-green-400 text-black font-extrabold text-xs tracking-wider uppercase"
          ...
          <div
            ...
            style={{ animation: 'fadeSlideIn 0.8s ease-out 1.3s both' }}
          >
        ...
        <section className="py-20 px-4">
          <Reveal className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-lg mx-auto">
              We&apos;re not here to waste your time. We want you to see real crypto in your wallet — fast.
            </p>
          </Reveal>
            ...
            {[
              {
                ...
                title: 'Instant Proof',
                desc: 'Cash out 10 YES and see real LTC hit your FaucetPay within 24h. No tricks, no hidden fees. Just crypto in your wallet.',
                color: 'green',
              ...
              },
              {
                ...
                title: 'Grind Smarter',
                desc: 'With a lower threshold, you can cash out more often. See your progress, stay motivated, and build your stack.',
                color: 'cyan',
              ...
              },
              {
                ...
                title: 'Trust First',
                desc: 'We earn your trust by paying you first. No massive minimums designed to keep your tokens locked. Your YES, your choice.',
                color: 'pink',
              ...
              <Reveal key={card.title} delay={i * 150}>
                <div className={`bg-white/5 backdrop-blur-sm border ${card.borderColor} ${card.hoverColor} rounded-2xl p-8 transition-all card-hover h-full`}>
                  <div className="w-16 h-16 rounded-xl bg-white/5 flex items-center justify-center mb-5">{card.icon}</div>
        ...
        <section className="py-20 px-4">
          <Reveal className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-md mx-auto">
              From zero to crypto in your wallet. Here&apos;s how.
            </p>
          </Reveal>
            ...
            {[
              {
                ...
                desc: <>Click to mine energy, discover rare resources, and explore planets at <span className="text-green-400 font-semibold">energy-empire.space</span>. Every click earns you Fuel.</>,
              },
              {
                num: '2',
                icon: '🔄',
                title: 'Convert to YES Tokens',
                desc: <>Head to the YieldVerse HUB and convert your Fuel into <span className="text-green-400 font-semibold">YES tokens</span> — the universal currency of the metaverse.</>,
              },
              {
                num: '3',
                icon: '💰',
                title: 'Cash Out to LTC',
                desc: <>With just <span className="text-green-400 font-semibold">10 YES</span>, cash out real Litecoin to your FaucetPay account. Instant processing, zero hidden fees.</>,
              },
            ].map((step, i) => (
              <Reveal key={step.num} delay={i * 150}>
                <div className="grid grid-cols-[60px_1fr] gap-5 py-8 relative">
                  {/* Connecting line */}
                  {i < 2 && (
                    <div className="absolute left-[29px] top-[68px] bottom-0 w-[2px] bg-gradient-to-b from-cyan-500/30 to-transparent" />
                  )}
                  <div className="w-[60px] h-[60px] flex items-center justify-center font-black text-xl text-cyan-400 border-2 border-cyan-400/30 bg-cyan-400/5 flex-shrink-0">
                    {step.num}
                  </div>
                  <div>
        ...
        <section className="py-20 px-4">
          <Reveal className="text-center mb-12">
            ...
            <p className="text-lg text-gray-400">We made every metric better for you.</p>
          </Reveal>
          ...
          <Reveal>
            <div className="max-w-2xl mx-auto border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm">
              ...
              {/* Rows */}
              {[
                ['Minimum YES', '100 YES', '10 YES ✅'],
                ['USD Value', '$0.10', '$0.01 ✅'],
                ['Time to First Payout', 'Days', 'Hours ✅'],
                ['Processing', '24h', 'Under 24h ✅'],
                ['Fees', 'None', 'Still None ✅'],
              ].map(([label, old, now], i) => (
                <div key={i} className="grid grid-cols-3 border-b border-white/5 last:border-b-0">
                  ...
                  <div className="p-4 text-sm text-red-400/60 line-through text-center">{old}</div>
                  <div className="p-4 text-sm text-green-400 font-bold text-center">{now}</div>
                </div>
              ))}
            </div>
          </Reveal>
        ...
        <section className="py-20 px-4">
          <Reveal>
            ...
            >
              {/* Rotating conic bg */}
              <div className="absolute inset-[-50%] -z-10"
                style={{
                  background: 'conic-gradient(from 0deg, transparent, rgba(57,255,20,0.03), transparent, rgba(0,240,255,0.03), transparent)',
              ...
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                We Believe <span className="bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent">In You</span>
              </h2>
              <p className="text-gray-400 max-w-md mx-auto leading-relaxed mb-8 text-base md:text-lg">
                Most platforms set high minimums to keep your earnings locked. We&apos;re different.
                We want you to see your first payout ASAP — because once you know it&apos;s real,
        ...
        <section className="py-20 px-4 text-center">
          <Reveal>
            <p className="text-5xl mb-6" style={{ animation: 'float 3s ease-in-out infinite' }}>🎮 ⚡ 💰</p>
            <h2 className="text-4xl md:text-6xl font-black mb-4">
              Ready to<br />
              <span className="bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">Get Paid?</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <a
                href="https://x.com/YesMetaverse"
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-4 border-2 border-white/20 rounded-full font-bold text-lg hover:border-cyan-400 hover:text-cyan-400 transition-all inline-flex items-center gap-2"
              >
                🐦 Follow on X
              </a>
            </div>
          ...
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span className="text-lg font-bold">
                Yield<span className="text-cyan-400">Verse</span> 🌍
              </span>
            </div>
            ...
            <div className="flex gap-6 justify-center">
              ...
              <a href="https://energy-empire.space" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-sm hover:text-cyan-400 transition-colors inline-flex items-center gap-1">
                Energy Empire<ExternalLink className="w-3 h-3" />
              </a>
              <a href="https://x.com/YesMetaverse" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-sm hover:text-cyan-400 transition-colors inline-flex items-center gap-1">
                Twitter / X<ExternalLink className="w-3 h-3" />
              </a>
            </div>
            <p className="text-gray-700 text-xs mt-6">© 2026 YieldVerse Metaverse. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </div>
